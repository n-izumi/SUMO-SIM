...
public class ChargingStation {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libtraciJNI.delete_ChargingStation(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public static String getParameter(String objectID, String param) {
    return libtraciJNI.ChargingStation_getParameter(objectID, param);
  }
  ...
  public static void setParameter(String objectID, String param, String value) {
    libtraciJNI.ChargingStation_setParameter(objectID, param, value);
  }

  public static void subscribe(String objectID, IntVector varIDs, double begin, double end, TraCIResults params) {
    libtraciJNI.ChargingStation_subscribe__SWIG_0(objectID, IntVector.getCPtr(varIDs), varIDs, begin, end, TraCIResults.getCPtr(params), params);
  }
  ...
  public static void subscribeContext(String objectID, int domain, double dist, IntVector varIDs, double begin, double end, TraCIResults params) {
    libtraciJNI.ChargingStation_subscribeContext__SWIG_0(objectID, domain, dist, IntVector.getCPtr(varIDs), varIDs, begin, end, TraCIResults.getCPtr(params), params);
  }
