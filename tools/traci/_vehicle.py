...
class VehicleDomain(VTypeDomain):
    ...
    def getLicenseNumber(self, vehID):
        """getLicenseNumber(string) -> integer
        Returns the total number of persons which includes those defined
        using attribute 'personNumber' as well as <License>-objects who are riding in
        this vehicle.
        """
        return self._getUniversal(tc.VAR_LICENSE_NUMBER, vehID)
