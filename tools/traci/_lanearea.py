...
class LaneAreaDomain(Domain):
    ...
    def getLaneIDs(self, detID):
        """getLaneID(string) -> list(string)

        Returns the id of the lane the detector is on.
        """
        return self._getUniversal(tc.VAR_LANE_IDS, detID)

    def getVehicleDistToDetectorEnd(self, detID, param):
        """getLaneID(string) -> string

        Returns the id of the lane the detector is on.
        """
        return self._getUniversal(tc.VAR_DIST_TO_DETECTOR_END, detID, "s", param)
