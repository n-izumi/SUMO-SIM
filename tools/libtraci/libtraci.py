...
SHARED_PTR_DISOWN = _libtraci.SHARED_PTR_DISOWN
...
class DoubleVector(_object):
    ...
    def iterator(self):
        return _libtraci.DoubleVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _libtraci.DoubleVector___nonzero__(self)

    def __bool__(self):
        return _libtraci.DoubleVector___bool__(self)

    def __len__(self):
        return _libtraci.DoubleVector___len__(self)

    def __getslice__(self, i, j):
        return _libtraci.DoubleVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _libtraci.DoubleVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _libtraci.DoubleVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _libtraci.DoubleVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _libtraci.DoubleVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _libtraci.DoubleVector___setitem__(self, *args)

    def pop(self):
        return _libtraci.DoubleVector_pop(self)

    def append(self, x):
        return _libtraci.DoubleVector_append(self, x)

    def empty(self):
        return _libtraci.DoubleVector_empty(self)

    def size(self):
        return _libtraci.DoubleVector_size(self)

    def swap(self, v):
        return _libtraci.DoubleVector_swap(self, v)

    def begin(self):
        return _libtraci.DoubleVector_begin(self)

    def end(self):
        return _libtraci.DoubleVector_end(self)

    def rbegin(self):
        return _libtraci.DoubleVector_rbegin(self)

    def rend(self):
        return _libtraci.DoubleVector_rend(self)

    def clear(self):
        return _libtraci.DoubleVector_clear(self)

    def get_allocator(self):
        return _libtraci.DoubleVector_get_allocator(self)

    def pop_back(self):
        return _libtraci.DoubleVector_pop_back(self)

    def erase(self, *args):
        return _libtraci.DoubleVector_erase(self, *args)

    def __init__(self, *args):
        this = _libtraci.new_DoubleVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _libtraci.DoubleVector_push_back(self, x)

    def front(self):
        return _libtraci.DoubleVector_front(self)

    def back(self):
        return _libtraci.DoubleVector_back(self)

    def assign(self, n, x):
        return _libtraci.DoubleVector_assign(self, n, x)

    def resize(self, *args):
        return _libtraci.DoubleVector_resize(self, *args)

    def insert(self, *args):
        return _libtraci.DoubleVector_insert(self, *args)

    def reserve(self, n):
        return _libtraci.DoubleVector_reserve(self, n)

    def capacity(self):
        return _libtraci.DoubleVector_capacity(self)
    __swig_destroy__ = _libtraci.delete_DoubleVector
    __del__ = lambda self: None
DoubleVector_swigregister = _libtraci.DoubleVector_swigregister
...
class StringStringPair(_object):
    ...
    def __init__(self, *args):
        this = _libtraci.new_StringStringPair(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["first"] = _libtraci.StringStringPair_first_set
    __swig_getmethods__["first"] = _libtraci.StringStringPair_first_get
    if _newclass:
        first = _swig_property(_libtraci.StringStringPair_first_get, _libtraci.StringStringPair_first_set)
    __swig_setmethods__["second"] = _libtraci.StringStringPair_second_set
    __swig_getmethods__["second"] = _libtraci.StringStringPair_second_get
    if _newclass:
        second = _swig_property(_libtraci.StringStringPair_second_get, _libtraci.StringStringPair_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _libtraci.delete_StringStringPair
    __del__ = lambda self: None
StringStringPair_swigregister = _libtraci.StringStringPair_swigregister
StringStringPair_swigregister(StringStringPair)

class IntStringPair(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IntStringPair, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IntStringPair, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _libtraci.new_IntStringPair(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["first"] = _libtraci.IntStringPair_first_set
    __swig_getmethods__["first"] = _libtraci.IntStringPair_first_get
    if _newclass:
        first = _swig_property(_libtraci.IntStringPair_first_get, _libtraci.IntStringPair_first_set)
    __swig_setmethods__["second"] = _libtraci.IntStringPair_second_set
    __swig_getmethods__["second"] = _libtraci.IntStringPair_second_get
    if _newclass:
        second = _swig_property(_libtraci.IntStringPair_second_get, _libtraci.IntStringPair_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _libtraci.delete_IntStringPair
    __del__ = lambda self: None
IntStringPair_swigregister = _libtraci.IntStringPair_swigregister
IntStringPair_swigregister(IntStringPair)
...
class IntIntPair(_object):
    ...
    def __init__(self, *args):
        this = _libtraci.new_IntIntPair(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["first"] = _libtraci.IntIntPair_first_set
    __swig_getmethods__["first"] = _libtraci.IntIntPair_first_get
    if _newclass:
        first = _swig_property(_libtraci.IntIntPair_first_get, _libtraci.IntIntPair_first_set)
    __swig_setmethods__["second"] = _libtraci.IntIntPair_second_set
    __swig_getmethods__["second"] = _libtraci.IntIntPair_second_get
    if _newclass:
        second = _swig_property(_libtraci.IntIntPair_second_get, _libtraci.IntIntPair_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _libtraci.delete_IntIntPair
    __del__ = lambda self: None
IntIntPair_swigregister = _libtraci.IntIntPair_swigregister
...
class StringDoublePair(_object):
    ...
    def __init__(self, *args):
        this = _libtraci.new_StringDoublePair(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["first"] = _libtraci.StringDoublePair_first_set
    __swig_getmethods__["first"] = _libtraci.StringDoublePair_first_get
    if _newclass:
        first = _swig_property(_libtraci.StringDoublePair_first_get, _libtraci.StringDoublePair_first_set)
    __swig_setmethods__["second"] = _libtraci.StringDoublePair_second_set
    __swig_getmethods__["second"] = _libtraci.StringDoublePair_second_get
    if _newclass:
        second = _swig_property(_libtraci.StringDoublePair_second_get, _libtraci.StringDoublePair_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _libtraci.delete_StringDoublePair
    __del__ = lambda self: None
StringDoublePair_swigregister = _libtraci.StringDoublePair_swigregister
StringDoublePair_swigregister(StringDoublePair)

class StringDoublePairVector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, StringDoublePairVector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, StringDoublePairVector, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _libtraci.StringDoublePairVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _libtraci.StringDoublePairVector___nonzero__(self)

    def __bool__(self):
        return _libtraci.StringDoublePairVector___bool__(self)

    def __len__(self):
        return _libtraci.StringDoublePairVector___len__(self)

    def __getslice__(self, i, j):
        return _libtraci.StringDoublePairVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _libtraci.StringDoublePairVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _libtraci.StringDoublePairVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _libtraci.StringDoublePairVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _libtraci.StringDoublePairVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _libtraci.StringDoublePairVector___setitem__(self, *args)

    def pop(self):
        return _libtraci.StringDoublePairVector_pop(self)

    def append(self, x):
        return _libtraci.StringDoublePairVector_append(self, x)

    def empty(self):
        return _libtraci.StringDoublePairVector_empty(self)

    def size(self):
        return _libtraci.StringDoublePairVector_size(self)

    def swap(self, v):
        return _libtraci.StringDoublePairVector_swap(self, v)

    def begin(self):
        return _libtraci.StringDoublePairVector_begin(self)

    def end(self):
        return _libtraci.StringDoublePairVector_end(self)

    def rbegin(self):
        return _libtraci.StringDoublePairVector_rbegin(self)

    def rend(self):
        return _libtraci.StringDoublePairVector_rend(self)

    def clear(self):
        return _libtraci.StringDoublePairVector_clear(self)

    def get_allocator(self):
        return _libtraci.StringDoublePairVector_get_allocator(self)

    def pop_back(self):
        return _libtraci.StringDoublePairVector_pop_back(self)

    def erase(self, *args):
        return _libtraci.StringDoublePairVector_erase(self, *args)

    def __init__(self, *args):
        this = _libtraci.new_StringDoublePairVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _libtraci.StringDoublePairVector_push_back(self, x)

    def front(self):
        return _libtraci.StringDoublePairVector_front(self)

    def back(self):
        return _libtraci.StringDoublePairVector_back(self)

    def assign(self, n, x):
        return _libtraci.StringDoublePairVector_assign(self, n, x)

    def resize(self, *args):
        return _libtraci.StringDoublePairVector_resize(self, *args)

    def insert(self, *args):
        return _libtraci.StringDoublePairVector_insert(self, *args)

    def reserve(self, n):
        return _libtraci.StringDoublePairVector_reserve(self, n)

    def capacity(self):
        return _libtraci.StringDoublePairVector_capacity(self)
    __swig_destroy__ = _libtraci.delete_StringDoublePairVector
    __del__ = lambda self: None
StringDoublePairVector_swigregister = _libtraci.StringDoublePairVector_swigregister
StringDoublePairVector_swigregister(StringDoublePairVector)
...
class TraCIDoubleList(TraCIResult):
    ...
    for _s in [TraCIResult]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, TraCIDoubleList, name, value)
    __swig_getmethods__ = {}
    for _s in [TraCIResult]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, TraCIDoubleList, name)
    __repr__ = _swig_repr

    def getString(self):
        return _libtraci.TraCIDoubleList_getString(self)
    __swig_setmethods__["value"] = _libtraci.TraCIDoubleList_value_set
    __swig_getmethods__["value"] = _libtraci.TraCIDoubleList_value_get
    if _newclass:
        value = _swig_property(_libtraci.TraCIDoubleList_value_get, _libtraci.TraCIDoubleList_value_set)

    def __init__(self):
        this = _libtraci.new_TraCIDoubleList()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _libtraci.delete_TraCIDoubleList
    __del__ = lambda self: None
TraCIDoubleList_swigregister = _libtraci.TraCIDoubleList_swigregister
TraCIDoubleList_swigregister(TraCIDoubleList)
...
class TraCILink(_object):
    ...
    def __init__(self, *args):
        this = _libtraci.new_TraCILink(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class TraCISignalConstraint(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["signalId"] = _libtraci.TraCISignalConstraint_signalId_set
    __swig_getmethods__["signalId"] = _libtraci.TraCISignalConstraint_signalId_get
    if _newclass:
        signalId = _swig_property(_libtraci.TraCISignalConstraint_signalId_get, _libtraci.TraCISignalConstraint_signalId_set)
    ...
    __swig_setmethods__["mustWait"] = _libtraci.TraCISignalConstraint_mustWait_set
    __swig_getmethods__["mustWait"] = _libtraci.TraCISignalConstraint_mustWait_get
    if _newclass:
        mustWait = _swig_property(_libtraci.TraCISignalConstraint_mustWait_get, _libtraci.TraCISignalConstraint_mustWait_set)
    __swig_setmethods__["active"] = _libtraci.TraCISignalConstraint_active_set
    __swig_getmethods__["active"] = _libtraci.TraCISignalConstraint_active_get
    if _newclass:
        active = _swig_property(_libtraci.TraCISignalConstraint_active_get, _libtraci.TraCISignalConstraint_active_set)
    __swig_setmethods__["param"] = _libtraci.TraCISignalConstraint_param_set
    __swig_getmethods__["param"] = _libtraci.TraCISignalConstraint_param_get
    if _newclass:
        param = _swig_property(_libtraci.TraCISignalConstraint_param_get, _libtraci.TraCISignalConstraint_param_set)
...
class TraCIJunctionFoe(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TraCIJunctionFoe, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TraCIJunctionFoe, name)
    __repr__ = _swig_repr
    __swig_setmethods__["foeId"] = _libtraci.TraCIJunctionFoe_foeId_set
    __swig_getmethods__["foeId"] = _libtraci.TraCIJunctionFoe_foeId_get
    if _newclass:
        foeId = _swig_property(_libtraci.TraCIJunctionFoe_foeId_get, _libtraci.TraCIJunctionFoe_foeId_set)
    __swig_setmethods__["egoDist"] = _libtraci.TraCIJunctionFoe_egoDist_set
    __swig_getmethods__["egoDist"] = _libtraci.TraCIJunctionFoe_egoDist_get
    if _newclass:
        egoDist = _swig_property(_libtraci.TraCIJunctionFoe_egoDist_get, _libtraci.TraCIJunctionFoe_egoDist_set)
    __swig_setmethods__["foeDist"] = _libtraci.TraCIJunctionFoe_foeDist_set
    __swig_getmethods__["foeDist"] = _libtraci.TraCIJunctionFoe_foeDist_get
    if _newclass:
        foeDist = _swig_property(_libtraci.TraCIJunctionFoe_foeDist_get, _libtraci.TraCIJunctionFoe_foeDist_set)
    __swig_setmethods__["egoExitDist"] = _libtraci.TraCIJunctionFoe_egoExitDist_set
    __swig_getmethods__["egoExitDist"] = _libtraci.TraCIJunctionFoe_egoExitDist_get
    if _newclass:
        egoExitDist = _swig_property(_libtraci.TraCIJunctionFoe_egoExitDist_get, _libtraci.TraCIJunctionFoe_egoExitDist_set)
    __swig_setmethods__["foeExitDist"] = _libtraci.TraCIJunctionFoe_foeExitDist_set
    __swig_getmethods__["foeExitDist"] = _libtraci.TraCIJunctionFoe_foeExitDist_get
    if _newclass:
        foeExitDist = _swig_property(_libtraci.TraCIJunctionFoe_foeExitDist_get, _libtraci.TraCIJunctionFoe_foeExitDist_set)
    __swig_setmethods__["egoLane"] = _libtraci.TraCIJunctionFoe_egoLane_set
    __swig_getmethods__["egoLane"] = _libtraci.TraCIJunctionFoe_egoLane_get
    if _newclass:
        egoLane = _swig_property(_libtraci.TraCIJunctionFoe_egoLane_get, _libtraci.TraCIJunctionFoe_egoLane_set)
    __swig_setmethods__["foeLane"] = _libtraci.TraCIJunctionFoe_foeLane_set
    __swig_getmethods__["foeLane"] = _libtraci.TraCIJunctionFoe_foeLane_get
    if _newclass:
        foeLane = _swig_property(_libtraci.TraCIJunctionFoe_foeLane_get, _libtraci.TraCIJunctionFoe_foeLane_set)
    __swig_setmethods__["egoResponse"] = _libtraci.TraCIJunctionFoe_egoResponse_set
    __swig_getmethods__["egoResponse"] = _libtraci.TraCIJunctionFoe_egoResponse_get
    if _newclass:
        egoResponse = _swig_property(_libtraci.TraCIJunctionFoe_egoResponse_get, _libtraci.TraCIJunctionFoe_egoResponse_set)
    __swig_setmethods__["foeResponse"] = _libtraci.TraCIJunctionFoe_foeResponse_set
    __swig_getmethods__["foeResponse"] = _libtraci.TraCIJunctionFoe_foeResponse_get
    if _newclass:
        foeResponse = _swig_property(_libtraci.TraCIJunctionFoe_foeResponse_get, _libtraci.TraCIJunctionFoe_foeResponse_set)

    def __init__(self):
        this = _libtraci.new_TraCIJunctionFoe()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _libtraci.delete_TraCIJunctionFoe
    __del__ = lambda self: None
TraCIJunctionFoe_swigregister = _libtraci.TraCIJunctionFoe_swigregister
TraCIJunctionFoe_swigregister(TraCIJunctionFoe)
...
class TraCICollisionVector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TraCICollisionVector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TraCICollisionVector, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _libtraci.TraCICollisionVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _libtraci.TraCICollisionVector___nonzero__(self)

    def __bool__(self):
        return _libtraci.TraCICollisionVector___bool__(self)

    def __len__(self):
        return _libtraci.TraCICollisionVector___len__(self)

    def __getslice__(self, i, j):
        return _libtraci.TraCICollisionVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _libtraci.TraCICollisionVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _libtraci.TraCICollisionVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _libtraci.TraCICollisionVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _libtraci.TraCICollisionVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _libtraci.TraCICollisionVector___setitem__(self, *args)

    def pop(self):
        return _libtraci.TraCICollisionVector_pop(self)

    def append(self, x):
        return _libtraci.TraCICollisionVector_append(self, x)

    def empty(self):
        return _libtraci.TraCICollisionVector_empty(self)

    def size(self):
        return _libtraci.TraCICollisionVector_size(self)

    def swap(self, v):
        return _libtraci.TraCICollisionVector_swap(self, v)

    def begin(self):
        return _libtraci.TraCICollisionVector_begin(self)

    def end(self):
        return _libtraci.TraCICollisionVector_end(self)

    def rbegin(self):
        return _libtraci.TraCICollisionVector_rbegin(self)

    def rend(self):
        return _libtraci.TraCICollisionVector_rend(self)

    def clear(self):
        return _libtraci.TraCICollisionVector_clear(self)

    def get_allocator(self):
        return _libtraci.TraCICollisionVector_get_allocator(self)

    def pop_back(self):
        return _libtraci.TraCICollisionVector_pop_back(self)

    def erase(self, *args):
        return _libtraci.TraCICollisionVector_erase(self, *args)

    def __init__(self, *args):
        this = _libtraci.new_TraCICollisionVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _libtraci.TraCICollisionVector_push_back(self, x)

    def front(self):
        return _libtraci.TraCICollisionVector_front(self)

    def back(self):
        return _libtraci.TraCICollisionVector_back(self)

    def assign(self, n, x):
        return _libtraci.TraCICollisionVector_assign(self, n, x)

    def resize(self, *args):
        return _libtraci.TraCICollisionVector_resize(self, *args)

    def insert(self, *args):
        return _libtraci.TraCICollisionVector_insert(self, *args)

    def reserve(self, n):
        return _libtraci.TraCICollisionVector_reserve(self, n)

    def capacity(self):
        return _libtraci.TraCICollisionVector_capacity(self)
    __swig_destroy__ = _libtraci.delete_TraCICollisionVector
    __del__ = lambda self: None
TraCICollisionVector_swigregister = _libtraci.TraCICollisionVector_swigregister
TraCICollisionVector_swigregister(TraCICollisionVector)

class TraCIJunctionFoeVector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TraCIJunctionFoeVector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TraCIJunctionFoeVector, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _libtraci.TraCIJunctionFoeVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _libtraci.TraCIJunctionFoeVector___nonzero__(self)

    def __bool__(self):
        return _libtraci.TraCIJunctionFoeVector___bool__(self)

    def __len__(self):
        return _libtraci.TraCIJunctionFoeVector___len__(self)

    def __getslice__(self, i, j):
        return _libtraci.TraCIJunctionFoeVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _libtraci.TraCIJunctionFoeVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _libtraci.TraCIJunctionFoeVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _libtraci.TraCIJunctionFoeVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _libtraci.TraCIJunctionFoeVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _libtraci.TraCIJunctionFoeVector___setitem__(self, *args)

    def pop(self):
        return _libtraci.TraCIJunctionFoeVector_pop(self)

    def append(self, x):
        return _libtraci.TraCIJunctionFoeVector_append(self, x)

    def empty(self):
        return _libtraci.TraCIJunctionFoeVector_empty(self)

    def size(self):
        return _libtraci.TraCIJunctionFoeVector_size(self)

    def swap(self, v):
        return _libtraci.TraCIJunctionFoeVector_swap(self, v)

    def begin(self):
        return _libtraci.TraCIJunctionFoeVector_begin(self)

    def end(self):
        return _libtraci.TraCIJunctionFoeVector_end(self)

    def rbegin(self):
        return _libtraci.TraCIJunctionFoeVector_rbegin(self)

    def rend(self):
        return _libtraci.TraCIJunctionFoeVector_rend(self)

    def clear(self):
        return _libtraci.TraCIJunctionFoeVector_clear(self)

    def get_allocator(self):
        return _libtraci.TraCIJunctionFoeVector_get_allocator(self)

    def pop_back(self):
        return _libtraci.TraCIJunctionFoeVector_pop_back(self)

    def erase(self, *args):
        return _libtraci.TraCIJunctionFoeVector_erase(self, *args)

    def __init__(self, *args):
        this = _libtraci.new_TraCIJunctionFoeVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _libtraci.TraCIJunctionFoeVector_push_back(self, x)

    def front(self):
        return _libtraci.TraCIJunctionFoeVector_front(self)

    def back(self):
        return _libtraci.TraCIJunctionFoeVector_back(self)

    def assign(self, n, x):
        return _libtraci.TraCIJunctionFoeVector_assign(self, n, x)

    def resize(self, *args):
        return _libtraci.TraCIJunctionFoeVector_resize(self, *args)

    def insert(self, *args):
        return _libtraci.TraCIJunctionFoeVector_insert(self, *args)

    def reserve(self, n):
        return _libtraci.TraCIJunctionFoeVector_reserve(self, n)

    def capacity(self):
        return _libtraci.TraCIJunctionFoeVector_capacity(self)
    __swig_destroy__ = _libtraci.delete_TraCIJunctionFoeVector
    __del__ = lambda self: None
TraCIJunctionFoeVector_swigregister = _libtraci.TraCIJunctionFoeVector_swigregister
TraCIJunctionFoeVector_swigregister(TraCIJunctionFoeVector)
...
class edge(_object):
    ...
    if _newclass:
        getMeanFriction = staticmethod(_libtraci.edge_getMeanFriction)
    else:
        getMeanFriction = _libtraci.edge_getMeanFriction
    if _newclass:
    ...
    if _newclass:
        setAllowed = staticmethod(_libtraci.edge_setAllowed)
    else:
        setAllowed = _libtraci.edge_setAllowed
    if _newclass:
        setDisallowed = staticmethod(_libtraci.edge_setDisallowed)
    else:
        setDisallowed = _libtraci.edge_setDisallowed
    if _newclass:
    ...
    if _newclass:
        setFriction = staticmethod(_libtraci.edge_setFriction)
    else:
        setFriction = _libtraci.edge_setFriction
...
def edge_getMeanFriction(edgeID):
    return _libtraci.edge_getMeanFriction(edgeID)
edge_getMeanFriction = _libtraci.edge_getMeanFriction
...
cvar = _libtraci.cvar
edge.DOMAIN_ID = _libtraci.cvar.edge_DOMAIN_ID

def edge_setAllowed(*args):
    return _libtraci.edge_setAllowed(*args)
edge_setAllowed = _libtraci.edge_setAllowed

def edge_setDisallowed(*args):
    return _libtraci.edge_setDisallowed(*args)
edge_setDisallowed = _libtraci.edge_setDisallowed
...
def edge_setFriction(edgeID, value):
    return _libtraci.edge_setFriction(edgeID, value)
edge_setFriction = _libtraci.edge_setFriction
...
class gui(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getZoom = staticmethod(_libtraci.gui_getZoom)
    else:
        getZoom = _libtraci.gui_getZoom
    if _newclass:
        getAngle = staticmethod(_libtraci.gui_getAngle)
    else:
        getAngle = _libtraci.gui_getAngle
    if _newclass:
        getOffset = staticmethod(_libtraci.gui_getOffset)
    else:
        getOffset = _libtraci.gui_getOffset
    if _newclass:
        getSchema = staticmethod(_libtraci.gui_getSchema)
    else:
        getSchema = _libtraci.gui_getSchema
    if _newclass:
        getBoundary = staticmethod(_libtraci.gui_getBoundary)
    else:
        getBoundary = _libtraci.gui_getBoundary
    if _newclass:
        hasView = staticmethod(_libtraci.gui_hasView)
    else:
        hasView = _libtraci.gui_hasView
    if _newclass:
        getTrackedVehicle = staticmethod(_libtraci.gui_getTrackedVehicle)
    else:
        getTrackedVehicle = _libtraci.gui_getTrackedVehicle
    if _newclass:
        isSelected = staticmethod(_libtraci.gui_isSelected)
    else:
        isSelected = _libtraci.gui_isSelected
    if _newclass:
        setZoom = staticmethod(_libtraci.gui_setZoom)
    else:
        setZoom = _libtraci.gui_setZoom
    if _newclass:
        setAngle = staticmethod(_libtraci.gui_setAngle)
    else:
        setAngle = _libtraci.gui_setAngle
    if _newclass:
        setOffset = staticmethod(_libtraci.gui_setOffset)
    else:
        setOffset = _libtraci.gui_setOffset
    if _newclass:
        setSchema = staticmethod(_libtraci.gui_setSchema)
    else:
        setSchema = _libtraci.gui_setSchema
    if _newclass:
        setBoundary = staticmethod(_libtraci.gui_setBoundary)
    else:
        setBoundary = _libtraci.gui_setBoundary
    if _newclass:
        trackVehicle = staticmethod(_libtraci.gui_trackVehicle)
    else:
        trackVehicle = _libtraci.gui_trackVehicle
    if _newclass:
        screenshot = staticmethod(_libtraci.gui_screenshot)
    else:
        screenshot = _libtraci.gui_screenshot
    if _newclass:
        track = staticmethod(_libtraci.gui_track)
    else:
        track = _libtraci.gui_track
    if _newclass:
        toggleSelection = staticmethod(_libtraci.gui_toggleSelection)
    else:
        toggleSelection = _libtraci.gui_toggleSelection
    if _newclass:
        addView = staticmethod(_libtraci.gui_addView)
    else:
        addView = _libtraci.gui_addView
    if _newclass:
        removeView = staticmethod(_libtraci.gui_removeView)
    else:
    ...
    if _newclass:
        getIDCount = staticmethod(_libtraci.gui_getIDCount)
    else:
        getIDCount = _libtraci.gui_getIDCount
    if _newclass:
        getParameter = staticmethod(_libtraci.gui_getParameter)
    else:
        getParameter = _libtraci.gui_getParameter
    if _newclass:
        getParameterWithKey = staticmethod(_libtraci.gui_getParameterWithKey)
    else:
        getParameterWithKey = _libtraci.gui_getParameterWithKey
    if _newclass:
        setParameter = staticmethod(_libtraci.gui_setParameter)
    else:
        setParameter = _libtraci.gui_setParameter
    if _newclass:
        subscribe = staticmethod(_libtraci.gui_subscribe)
    else:
        subscribe = _libtraci.gui_subscribe
    if _newclass:
        unsubscribe = staticmethod(_libtraci.gui_unsubscribe)
    else:
        unsubscribe = _libtraci.gui_unsubscribe
    if _newclass:
        subscribeContext = staticmethod(_libtraci.gui_subscribeContext)
    else:
        subscribeContext = _libtraci.gui_subscribeContext
    if _newclass:
        unsubscribeContext = staticmethod(_libtraci.gui_unsubscribeContext)
    else:
        unsubscribeContext = _libtraci.gui_unsubscribeContext
    if _newclass:
        getAllSubscriptionResults = staticmethod(_libtraci.gui_getAllSubscriptionResults)
    else:
        getAllSubscriptionResults = _libtraci.gui_getAllSubscriptionResults
    if _newclass:
        getSubscriptionResults = staticmethod(_libtraci.gui_getSubscriptionResults)
    else:
        getSubscriptionResults = _libtraci.gui_getSubscriptionResults
    if _newclass:
        getAllContextSubscriptionResults = staticmethod(_libtraci.gui_getAllContextSubscriptionResults)
    else:
        getAllContextSubscriptionResults = _libtraci.gui_getAllContextSubscriptionResults
    if _newclass:
        getContextSubscriptionResults = staticmethod(_libtraci.gui_getContextSubscriptionResults)
    else:
        getContextSubscriptionResults = _libtraci.gui_getContextSubscriptionResults
    if _newclass:
        subscribeParameterWithKey = staticmethod(_libtraci.gui_subscribeParameterWithKey)
    else:
        subscribeParameterWithKey = _libtraci.gui_subscribeParameterWithKey
    __swig_destroy__ = _libtraci.delete_gui
    __del__ = lambda self: None
gui_swigregister = _libtraci.gui_swigregister
gui_swigregister(gui)

def gui_getZoom(*args, **kwargs):
    return _libtraci.gui_getZoom(*args, **kwargs)
gui_getZoom = _libtraci.gui_getZoom

def gui_getAngle(*args, **kwargs):
    return _libtraci.gui_getAngle(*args, **kwargs)
gui_getAngle = _libtraci.gui_getAngle

def gui_getOffset(*args, **kwargs):
    return _libtraci.gui_getOffset(*args, **kwargs)
gui_getOffset = _libtraci.gui_getOffset

def gui_getSchema(*args, **kwargs):
    return _libtraci.gui_getSchema(*args, **kwargs)
gui_getSchema = _libtraci.gui_getSchema

def gui_getBoundary(*args, **kwargs):
    return _libtraci.gui_getBoundary(*args, **kwargs)
gui_getBoundary = _libtraci.gui_getBoundary

def gui_hasView(*args, **kwargs):
    return _libtraci.gui_hasView(*args, **kwargs)
gui_hasView = _libtraci.gui_hasView

def gui_getTrackedVehicle(*args, **kwargs):
    return _libtraci.gui_getTrackedVehicle(*args, **kwargs)
gui_getTrackedVehicle = _libtraci.gui_getTrackedVehicle

def gui_isSelected(*args, **kwargs):
    return _libtraci.gui_isSelected(*args, **kwargs)
gui_isSelected = _libtraci.gui_isSelected

def gui_setZoom(viewID, zoom):
    return _libtraci.gui_setZoom(viewID, zoom)
gui_setZoom = _libtraci.gui_setZoom

def gui_setAngle(viewID, angle):
    return _libtraci.gui_setAngle(viewID, angle)
gui_setAngle = _libtraci.gui_setAngle

def gui_setOffset(viewID, x, y):
    return _libtraci.gui_setOffset(viewID, x, y)
gui_setOffset = _libtraci.gui_setOffset

def gui_setSchema(viewID, schemeName):
    return _libtraci.gui_setSchema(viewID, schemeName)
gui_setSchema = _libtraci.gui_setSchema

def gui_setBoundary(viewID, xmin, ymin, xmax, ymax):
    return _libtraci.gui_setBoundary(viewID, xmin, ymin, xmax, ymax)
gui_setBoundary = _libtraci.gui_setBoundary

def gui_trackVehicle(viewID, vehID):
    return _libtraci.gui_trackVehicle(viewID, vehID)
gui_trackVehicle = _libtraci.gui_trackVehicle

def gui_screenshot(viewID, filename, width=-1, height=-1):
    return _libtraci.gui_screenshot(viewID, filename, width, height)
gui_screenshot = _libtraci.gui_screenshot

def gui_track(*args, **kwargs):
    return _libtraci.gui_track(*args, **kwargs)
gui_track = _libtraci.gui_track

def gui_toggleSelection(*args, **kwargs):
    return _libtraci.gui_toggleSelection(*args, **kwargs)
gui_toggleSelection = _libtraci.gui_toggleSelection

def gui_addView(*args, **kwargs):
    return _libtraci.gui_addView(*args, **kwargs)
gui_addView = _libtraci.gui_addView
...
class inductionloop(_object):
    ...
    if _newclass:
        getIntervalOccupancy = staticmethod(_libtraci.inductionloop_getIntervalOccupancy)
    else:
        getIntervalOccupancy = _libtraci.inductionloop_getIntervalOccupancy
    if _newclass:
        getIntervalMeanSpeed = staticmethod(_libtraci.inductionloop_getIntervalMeanSpeed)
    else:
        getIntervalMeanSpeed = _libtraci.inductionloop_getIntervalMeanSpeed
    if _newclass:
        getIntervalVehicleNumber = staticmethod(_libtraci.inductionloop_getIntervalVehicleNumber)
    else:
        getIntervalVehicleNumber = _libtraci.inductionloop_getIntervalVehicleNumber
    if _newclass:
        getIntervalVehicleIDs = staticmethod(_libtraci.inductionloop_getIntervalVehicleIDs)
    else:
        getIntervalVehicleIDs = _libtraci.inductionloop_getIntervalVehicleIDs
    if _newclass:
        getLastIntervalOccupancy = staticmethod(_libtraci.inductionloop_getLastIntervalOccupancy)
    else:
        getLastIntervalOccupancy = _libtraci.inductionloop_getLastIntervalOccupancy
    if _newclass:
        getLastIntervalMeanSpeed = staticmethod(_libtraci.inductionloop_getLastIntervalMeanSpeed)
    else:
        getLastIntervalMeanSpeed = _libtraci.inductionloop_getLastIntervalMeanSpeed
    if _newclass:
        getLastIntervalVehicleNumber = staticmethod(_libtraci.inductionloop_getLastIntervalVehicleNumber)
    else:
        getLastIntervalVehicleNumber = _libtraci.inductionloop_getLastIntervalVehicleNumber
    if _newclass:
        getLastIntervalVehicleIDs = staticmethod(_libtraci.inductionloop_getLastIntervalVehicleIDs)
    else:
        getLastIntervalVehicleIDs = _libtraci.inductionloop_getLastIntervalVehicleIDs
    if _newclass:
        overrideTimeSinceDetection = staticmethod(_libtraci.inductionloop_overrideTimeSinceDetection)
    else:
        overrideTimeSinceDetection = _libtraci.inductionloop_overrideTimeSinceDetection
    if _newclass:
...
def inductionloop_getIntervalOccupancy(detID):
    return _libtraci.inductionloop_getIntervalOccupancy(detID)
inductionloop_getIntervalOccupancy = _libtraci.inductionloop_getIntervalOccupancy

def inductionloop_getIntervalMeanSpeed(detID):
    return _libtraci.inductionloop_getIntervalMeanSpeed(detID)
inductionloop_getIntervalMeanSpeed = _libtraci.inductionloop_getIntervalMeanSpeed

def inductionloop_getIntervalVehicleNumber(detID):
    return _libtraci.inductionloop_getIntervalVehicleNumber(detID)
inductionloop_getIntervalVehicleNumber = _libtraci.inductionloop_getIntervalVehicleNumber

def inductionloop_getIntervalVehicleIDs(detID):
    return _libtraci.inductionloop_getIntervalVehicleIDs(detID)
inductionloop_getIntervalVehicleIDs = _libtraci.inductionloop_getIntervalVehicleIDs

def inductionloop_getLastIntervalOccupancy(detID):
    return _libtraci.inductionloop_getLastIntervalOccupancy(detID)
inductionloop_getLastIntervalOccupancy = _libtraci.inductionloop_getLastIntervalOccupancy

def inductionloop_getLastIntervalMeanSpeed(detID):
    return _libtraci.inductionloop_getLastIntervalMeanSpeed(detID)
inductionloop_getLastIntervalMeanSpeed = _libtraci.inductionloop_getLastIntervalMeanSpeed

def inductionloop_getLastIntervalVehicleNumber(detID):
    return _libtraci.inductionloop_getLastIntervalVehicleNumber(detID)
inductionloop_getLastIntervalVehicleNumber = _libtraci.inductionloop_getLastIntervalVehicleNumber

def inductionloop_getLastIntervalVehicleIDs(detID):
    return _libtraci.inductionloop_getLastIntervalVehicleIDs(detID)
inductionloop_getLastIntervalVehicleIDs = _libtraci.inductionloop_getLastIntervalVehicleIDs

def inductionloop_overrideTimeSinceDetection(detID, time):
    return _libtraci.inductionloop_overrideTimeSinceDetection(detID, time)
inductionloop_overrideTimeSinceDetection = _libtraci.inductionloop_overrideTimeSinceDetection
...
inductionloop.DOMAIN_ID = _libtraci.cvar.inductionloop_DOMAIN_ID
...
junction.DOMAIN_ID = _libtraci.cvar.junction_DOMAIN_ID
...
class lanearea(_object):
    ...
    if _newclass:
        getLaneIDs = staticmethod(_libtraci.lanearea_getLaneIDs)
    else:
        getLaneIDs = _libtraci.lanearea_getLaneIDs
    if _newclass:
        getVehicleDistToDetectorEnd = staticmethod(_libtraci.lanearea_getVehicleDistToDetectorEnd)
    else:
        getVehicleDistToDetectorEnd = _libtraci.lanearea_getVehicleDistToDetectorEnd
    if _newclass:
    ...
    if _newclass:
        getIntervalOccupancy = staticmethod(_libtraci.lanearea_getIntervalOccupancy)
    else:
        getIntervalOccupancy = _libtraci.lanearea_getIntervalOccupancy
    if _newclass:
        getIntervalMeanSpeed = staticmethod(_libtraci.lanearea_getIntervalMeanSpeed)
    else:
        getIntervalMeanSpeed = _libtraci.lanearea_getIntervalMeanSpeed
    if _newclass:
        getIntervalMaxJamLengthInMeters = staticmethod(_libtraci.lanearea_getIntervalMaxJamLengthInMeters)
    else:
        getIntervalMaxJamLengthInMeters = _libtraci.lanearea_getIntervalMaxJamLengthInMeters
    if _newclass:
        getIntervalVehicleNumber = staticmethod(_libtraci.lanearea_getIntervalVehicleNumber)
    else:
        getIntervalVehicleNumber = _libtraci.lanearea_getIntervalVehicleNumber
    if _newclass:
        getLastIntervalOccupancy = staticmethod(_libtraci.lanearea_getLastIntervalOccupancy)
    else:
        getLastIntervalOccupancy = _libtraci.lanearea_getLastIntervalOccupancy
    if _newclass:
        getLastIntervalMeanSpeed = staticmethod(_libtraci.lanearea_getLastIntervalMeanSpeed)
    else:
        getLastIntervalMeanSpeed = _libtraci.lanearea_getLastIntervalMeanSpeed
    if _newclass:
        getLastIntervalMaxJamLengthInMeters = staticmethod(_libtraci.lanearea_getLastIntervalMaxJamLengthInMeters)
    else:
        getLastIntervalMaxJamLengthInMeters = _libtraci.lanearea_getLastIntervalMaxJamLengthInMeters
    if _newclass:
        getLastIntervalVehicleNumber = staticmethod(_libtraci.lanearea_getLastIntervalVehicleNumber)
    else:
        getLastIntervalVehicleNumber = _libtraci.lanearea_getLastIntervalVehicleNumber
    if _newclass:
        overrideVehicleNumber = staticmethod(_libtraci.lanearea_overrideVehicleNumber)
    else:
        overrideVehicleNumber = _libtraci.lanearea_overrideVehicleNumber
    if _newclass:
...
def lanearea_getLaneIDs(detID):
    return _libtraci.lanearea_getLaneIDs(detID)
lanearea_getLaneIDs = _libtraci.lanearea_getLaneIDs

def lanearea_getVehicleDistToDetectorEnd(detID, param):
    return _libtraci.lanearea_getVehicleDistToDetectorEnd(detID, param)
lanearea_getVehicleDistToDetectorEnd = _libtraci.lanearea_getVehicleDistToDetectorEnd
...
def lanearea_getIntervalOccupancy(detID):
    return _libtraci.lanearea_getIntervalOccupancy(detID)
lanearea_getIntervalOccupancy = _libtraci.lanearea_getIntervalOccupancy

def lanearea_getIntervalMeanSpeed(detID):
    return _libtraci.lanearea_getIntervalMeanSpeed(detID)
lanearea_getIntervalMeanSpeed = _libtraci.lanearea_getIntervalMeanSpeed

def lanearea_getIntervalMaxJamLengthInMeters(detID):
    return _libtraci.lanearea_getIntervalMaxJamLengthInMeters(detID)
lanearea_getIntervalMaxJamLengthInMeters = _libtraci.lanearea_getIntervalMaxJamLengthInMeters

def lanearea_getIntervalVehicleNumber(detID):
    return _libtraci.lanearea_getIntervalVehicleNumber(detID)
lanearea_getIntervalVehicleNumber = _libtraci.lanearea_getIntervalVehicleNumber

def lanearea_getLastIntervalOccupancy(detID):
    return _libtraci.lanearea_getLastIntervalOccupancy(detID)
lanearea_getLastIntervalOccupancy = _libtraci.lanearea_getLastIntervalOccupancy

def lanearea_getLastIntervalMeanSpeed(detID):
    return _libtraci.lanearea_getLastIntervalMeanSpeed(detID)
lanearea_getLastIntervalMeanSpeed = _libtraci.lanearea_getLastIntervalMeanSpeed

def lanearea_getLastIntervalMaxJamLengthInMeters(detID):
    return _libtraci.lanearea_getLastIntervalMaxJamLengthInMeters(detID)
lanearea_getLastIntervalMaxJamLengthInMeters = _libtraci.lanearea_getLastIntervalMaxJamLengthInMeters

def lanearea_getLastIntervalVehicleNumber(detID):
    return _libtraci.lanearea_getLastIntervalVehicleNumber(detID)
lanearea_getLastIntervalVehicleNumber = _libtraci.lanearea_getLastIntervalVehicleNumber

def lanearea_overrideVehicleNumber(detID, num):
    return _libtraci.lanearea_overrideVehicleNumber(detID, num)
lanearea_overrideVehicleNumber = _libtraci.lanearea_overrideVehicleNumber
...
lanearea.DOMAIN_ID = _libtraci.cvar.lanearea_DOMAIN_ID
...
class lane(_object):
    ...
    if _newclass:
        getFriction = staticmethod(_libtraci.lane_getFriction)
    else:
        getFriction = _libtraci.lane_getFriction
    if _newclass:
    ...
    if _newclass:
        getChangePermissions = staticmethod(_libtraci.lane_getChangePermissions)
    else:
        getChangePermissions = _libtraci.lane_getChangePermissions
    if _newclass:
    ...
    if _newclass:
        setChangePermissions = staticmethod(_libtraci.lane_setChangePermissions)
    else:
        setChangePermissions = _libtraci.lane_setChangePermissions
    if _newclass:
    ...
    if _newclass:
        setFriction = staticmethod(_libtraci.lane_setFriction)
    else:
        setFriction = _libtraci.lane_setFriction
...
def lane_getFriction(laneID):
    return _libtraci.lane_getFriction(laneID)
lane_getFriction = _libtraci.lane_getFriction
...
def lane_getChangePermissions(laneID, direction):
    return _libtraci.lane_getChangePermissions(laneID, direction)
lane_getChangePermissions = _libtraci.lane_getChangePermissions
...
lane.DOMAIN_ID = _libtraci.cvar.lane_DOMAIN_ID

def lane_setAllowed(*args):
    return _libtraci.lane_setAllowed(*args)
lane_setAllowed = _libtraci.lane_setAllowed

def lane_setDisallowed(*args):
    return _libtraci.lane_setDisallowed(*args)
lane_setDisallowed = _libtraci.lane_setDisallowed

def lane_setChangePermissions(laneID, allowedClasses, direction):
    return _libtraci.lane_setChangePermissions(laneID, allowedClasses, direction)
lane_setChangePermissions = _libtraci.lane_setChangePermissions
...
def lane_setFriction(laneID, friction):
    return _libtraci.lane_setFriction(laneID, friction)
lane_setFriction = _libtraci.lane_setFriction
...
class multientryexit(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getEntryLanes = staticmethod(_libtraci.multientryexit_getEntryLanes)
    else:
        getEntryLanes = _libtraci.multientryexit_getEntryLanes
    if _newclass:
        getExitLanes = staticmethod(_libtraci.multientryexit_getExitLanes)
    else:
        getExitLanes = _libtraci.multientryexit_getExitLanes
    if _newclass:
        getEntryPositions = staticmethod(_libtraci.multientryexit_getEntryPositions)
    else:
        getEntryPositions = _libtraci.multientryexit_getEntryPositions
    if _newclass:
        getExitPositions = staticmethod(_libtraci.multientryexit_getExitPositions)
    else:
        getExitPositions = _libtraci.multientryexit_getExitPositions
    if _newclass:
    ...
    if _newclass:
        getLastIntervalMeanTravelTime = staticmethod(_libtraci.multientryexit_getLastIntervalMeanTravelTime)
    else:
        getLastIntervalMeanTravelTime = _libtraci.multientryexit_getLastIntervalMeanTravelTime
    if _newclass:
        getLastIntervalMeanHaltsPerVehicle = staticmethod(_libtraci.multientryexit_getLastIntervalMeanHaltsPerVehicle)
    else:
        getLastIntervalMeanHaltsPerVehicle = _libtraci.multientryexit_getLastIntervalMeanHaltsPerVehicle
    if _newclass:
        getLastIntervalMeanTimeLoss = staticmethod(_libtraci.multientryexit_getLastIntervalMeanTimeLoss)
    else:
        getLastIntervalMeanTimeLoss = _libtraci.multientryexit_getLastIntervalMeanTimeLoss
    if _newclass:
        getLastIntervalVehicleSum = staticmethod(_libtraci.multientryexit_getLastIntervalVehicleSum)
    else:
        getLastIntervalVehicleSum = _libtraci.multientryexit_getLastIntervalVehicleSum
    if _newclass:
...
def multientryexit_getEntryLanes(detID):
    return _libtraci.multientryexit_getEntryLanes(detID)
multientryexit_getEntryLanes = _libtraci.multientryexit_getEntryLanes

def multientryexit_getExitLanes(detID):
    return _libtraci.multientryexit_getExitLanes(detID)
multientryexit_getExitLanes = _libtraci.multientryexit_getExitLanes

def multientryexit_getEntryPositions(detID):
    return _libtraci.multientryexit_getEntryPositions(detID)
multientryexit_getEntryPositions = _libtraci.multientryexit_getEntryPositions

def multientryexit_getExitPositions(detID):
    return _libtraci.multientryexit_getExitPositions(detID)
multientryexit_getExitPositions = _libtraci.multientryexit_getExitPositions
...
def multientryexit_getLastIntervalMeanTravelTime(detID):
    return _libtraci.multientryexit_getLastIntervalMeanTravelTime(detID)
multientryexit_getLastIntervalMeanTravelTime = _libtraci.multientryexit_getLastIntervalMeanTravelTime

def multientryexit_getLastIntervalMeanHaltsPerVehicle(detID):
    return _libtraci.multientryexit_getLastIntervalMeanHaltsPerVehicle(detID)
multientryexit_getLastIntervalMeanHaltsPerVehicle = _libtraci.multientryexit_getLastIntervalMeanHaltsPerVehicle

def multientryexit_getLastIntervalMeanTimeLoss(detID):
    return _libtraci.multientryexit_getLastIntervalMeanTimeLoss(detID)
multientryexit_getLastIntervalMeanTimeLoss = _libtraci.multientryexit_getLastIntervalMeanTimeLoss

def multientryexit_getLastIntervalVehicleSum(detID):
    return _libtraci.multientryexit_getLastIntervalVehicleSum(detID)
multientryexit_getLastIntervalVehicleSum = _libtraci.multientryexit_getLastIntervalVehicleSum
...
multientryexit.DOMAIN_ID = _libtraci.cvar.multientryexit_DOMAIN_ID
...
poi.DOMAIN_ID = _libtraci.cvar.poi_DOMAIN_ID
...
polygon.DOMAIN_ID = _libtraci.cvar.polygon_DOMAIN_ID
...
route.DOMAIN_ID = _libtraci.cvar.route_DOMAIN_ID
...
class simulation(_object):
    ...
    if _newclass:
        executeMove = staticmethod(_libtraci.simulation_executeMove)
    else:
        executeMove = _libtraci.simulation_executeMove
    if _newclass:
    ...
    if _newclass:
        getOption = staticmethod(_libtraci.simulation_getOption)
    else:
        getOption = _libtraci.simulation_getOption
    if _newclass:
    ...
    if _newclass:
        getEndTime = staticmethod(_libtraci.simulation_getEndTime)
    else:
        getEndTime = _libtraci.simulation_getEndTime
    if _newclass:
    ...
    if _newclass:
        getDepartedPersonNumber = staticmethod(_libtraci.simulation_getDepartedPersonNumber)
    else:
        getDepartedPersonNumber = _libtraci.simulation_getDepartedPersonNumber
    if _newclass:
        getDepartedPersonIDList = staticmethod(_libtraci.simulation_getDepartedPersonIDList)
    else:
        getDepartedPersonIDList = _libtraci.simulation_getDepartedPersonIDList
    if _newclass:
        getArrivedPersonNumber = staticmethod(_libtraci.simulation_getArrivedPersonNumber)
    else:
        getArrivedPersonNumber = _libtraci.simulation_getArrivedPersonNumber
    if _newclass:
        getArrivedPersonIDList = staticmethod(_libtraci.simulation_getArrivedPersonIDList)
    else:
        getArrivedPersonIDList = _libtraci.simulation_getArrivedPersonIDList
    if _newclass:
    ...
    if _newclass:
        getScale = staticmethod(_libtraci.simulation_getScale)
    else:
        getScale = _libtraci.simulation_getScale
    if _newclass:
    ...
    if _newclass:
        setScale = staticmethod(_libtraci.simulation_setScale)
    else:
    ...
    if _newclass:
        unsubscribe = staticmethod(_libtraci.simulation_unsubscribe)
    else:
        unsubscribe = _libtraci.simulation_unsubscribe
    if _newclass:
        subscribeContext = staticmethod(_libtraci.simulation_subscribeContext)
    else:
        subscribeContext = _libtraci.simulation_subscribeContext
    if _newclass:
        unsubscribeContext = staticmethod(_libtraci.simulation_unsubscribeContext)
    else:
        unsubscribeContext = _libtraci.simulation_unsubscribeContext
    if _newclass:
    ...
    if _newclass:
        getContextSubscriptionResults = staticmethod(_libtraci.simulation_getContextSubscriptionResults)
    else:
        getContextSubscriptionResults = _libtraci.simulation_getContextSubscriptionResults
    if _newclass:
        subscribeParameterWithKey = staticmethod(_libtraci.simulation_subscribeParameterWithKey)
    else:
        subscribeParameterWithKey = _libtraci.simulation_subscribeParameterWithKey
...
def simulation_executeMove():
    return _libtraci.simulation_executeMove()
simulation_executeMove = _libtraci.simulation_executeMove
...
def simulation_getOption(option):
    return _libtraci.simulation_getOption(option)
simulation_getOption = _libtraci.simulation_getOption
...
def simulation_getEndTime():
    return _libtraci.simulation_getEndTime()
simulation_getEndTime = _libtraci.simulation_getEndTime
...
simulation_getDepartedPersonNumber = _libtraci.simulation_getDepartedPersonNumber

def simulation_getDepartedPersonIDList():
    return _libtraci.simulation_getDepartedPersonIDList()
simulation_getDepartedPersonIDList = _libtraci.simulation_getDepartedPersonIDList

def simulation_getArrivedPersonNumber():
    return _libtraci.simulation_getArrivedPersonNumber()
simulation_getArrivedPersonNumber = _libtraci.simulation_getArrivedPersonNumber

def simulation_getArrivedPersonIDList():
    return _libtraci.simulation_getArrivedPersonIDList()
simulation_getArrivedPersonIDList = _libtraci.simulation_getArrivedPersonIDList
...
def simulation_getScale():
    return _libtraci.simulation_getScale()
simulation_getScale = _libtraci.simulation_getScale
...
simulation_unsubscribe = _libtraci.simulation_unsubscribe

def simulation_subscribeContext(*args, **kwargs):
    return _libtraci.simulation_subscribeContext(*args, **kwargs)
simulation_subscribeContext = _libtraci.simulation_subscribeContext
...
simulation_unsubscribeContext = _libtraci.simulation_unsubscribeContext
...
simulation_getContextSubscriptionResults = _libtraci.simulation_getContextSubscriptionResults

def simulation_subscribeParameterWithKey(*args, **kwargs):
    return _libtraci.simulation_subscribeParameterWithKey(*args, **kwargs)
simulation_subscribeParameterWithKey = _libtraci.simulation_subscribeParameterWithKey
simulation.DOMAIN_ID = _libtraci.cvar.simulation_DOMAIN_ID
...
class trafficlight(_object):
    ...
    if _newclass:
        getConstraintsByFoe = staticmethod(_libtraci.trafficlight_getConstraintsByFoe)
    else:
        getConstraintsByFoe = _libtraci.trafficlight_getConstraintsByFoe
    if _newclass:
    ...
    if _newclass:
        swapConstraints = staticmethod(_libtraci.trafficlight_swapConstraints)
    else:
        swapConstraints = _libtraci.trafficlight_swapConstraints
    if _newclass:
        removeConstraints = staticmethod(_libtraci.trafficlight_removeConstraints)
    else:
        removeConstraints = _libtraci.trafficlight_removeConstraints
    if _newclass:
        updateConstraints = staticmethod(_libtraci.trafficlight_updateConstraints)
    else:
        updateConstraints = _libtraci.trafficlight_updateConstraints
    if _newclass:
    ...
    if _newclass:
        setNemaSplits = staticmethod(_libtraci.trafficlight_setNemaSplits)
    else:
        setNemaSplits = _libtraci.trafficlight_setNemaSplits
    if _newclass:
        setNemaMaxGreens = staticmethod(_libtraci.trafficlight_setNemaMaxGreens)
    else:
        setNemaMaxGreens = _libtraci.trafficlight_setNemaMaxGreens
    if _newclass:
        setNemaCycleLength = staticmethod(_libtraci.trafficlight_setNemaCycleLength)
    else:
        setNemaCycleLength = _libtraci.trafficlight_setNemaCycleLength
    if _newclass:
        setNemaOffset = staticmethod(_libtraci.trafficlight_setNemaOffset)
    else:
        setNemaOffset = _libtraci.trafficlight_setNemaOffset
...
VAR_LANE_IDS = cvar.VAR_LANE_IDS
VAR_DIST_TO_DETECTOR_END = cvar.VAR_DIST_TO_DETECTOR_END
...
VAR_LICENSE_NUMBER = cvar.VAR_LICENSE_NUMBER
...
trafficlight_getConstraintsByFoe = _libtraci.trafficlight_getConstraintsByFoe
...
trafficlight.DOMAIN_ID = _libtraci.cvar.trafficlight_DOMAIN_ID
...
trafficlight_swapConstraints = _libtraci.trafficlight_swapConstraints
...
trafficlight_removeConstraints = _libtraci.trafficlight_removeConstraints

def trafficlight_updateConstraints(*args, **kwargs):
    return _libtraci.trafficlight_updateConstraints(*args, **kwargs)
trafficlight_updateConstraints = _libtraci.trafficlight_updateConstraints
...
def trafficlight_setNemaSplits(tlsID, splits):
    return _libtraci.trafficlight_setNemaSplits(tlsID, splits)
trafficlight_setNemaSplits = _libtraci.trafficlight_setNemaSplits

def trafficlight_setNemaMaxGreens(tlsID, maxGreens):
    return _libtraci.trafficlight_setNemaMaxGreens(tlsID, maxGreens)
trafficlight_setNemaMaxGreens = _libtraci.trafficlight_setNemaMaxGreens

def trafficlight_setNemaCycleLength(tlsID, cycleLength):
    return _libtraci.trafficlight_setNemaCycleLength(tlsID, cycleLength)
trafficlight_setNemaCycleLength = _libtraci.trafficlight_setNemaCycleLength

def trafficlight_setNemaOffset(tlsID, offset):
    return _libtraci.trafficlight_setNemaOffset(tlsID, offset)
trafficlight_setNemaOffset = _libtraci.trafficlight_setNemaOffset
...
class vehicletype(_object):
    ...
    if _newclass:
        getBoardingDuration = staticmethod(_libtraci.vehicletype_getBoardingDuration)
    else:
        getBoardingDuration = _libtraci.vehicletype_getBoardingDuration
    if _newclass:
    ...
    if _newclass:
        getScale = staticmethod(_libtraci.vehicletype_getScale)
    else:
        getScale = _libtraci.vehicletype_getScale
    if _newclass:
        setScale = staticmethod(_libtraci.vehicletype_setScale)
    else:
        setScale = _libtraci.vehicletype_setScale
    if _newclass:
...
def vehicletype_getBoardingDuration(typeID):
    return _libtraci.vehicletype_getBoardingDuration(typeID)
vehicletype_getBoardingDuration = _libtraci.vehicletype_getBoardingDuration
...
def vehicletype_getScale(typeID):
    return _libtraci.vehicletype_getScale(typeID)
vehicletype_getScale = _libtraci.vehicletype_getScale

def vehicletype_setScale(typeID, value):
    return _libtraci.vehicletype_setScale(typeID, value)
vehicletype_setScale = _libtraci.vehicletype_setScale
...
vehicletype.DOMAIN_ID = _libtraci.cvar.vehicletype_DOMAIN_ID
...
class vehicle(_object):
    ...
    if _newclass:
        getDeparture = staticmethod(_libtraci.vehicle_getDeparture)
    else:
        getDeparture = _libtraci.vehicle_getDeparture
    if _newclass:
        getDepartDelay = staticmethod(_libtraci.vehicle_getDepartDelay)
    else:
        getDepartDelay = _libtraci.vehicle_getDepartDelay
    if _newclass:
    ...
    if _newclass:
        getLicenseNumber = staticmethod(_libtraci.vehicle_getLicenseNumber)
    else:
        getLicenseNumber = _libtraci.vehicle_getLicenseNumber
    if _newclass:
    ...
    def getLeader(vehID, dist=0.):
        val = _libtraci.vehicle_getLeader(vehID, dist)
    ...
    if _newclass:
        getJunctionFoes = staticmethod(_libtraci.vehicle_getJunctionFoes)
    else:
        getJunctionFoes = _libtraci.vehicle_getJunctionFoes
    if _newclass:
    ...
    if _newclass:
        getNextLinks = staticmethod(_libtraci.vehicle_getNextLinks)
    else:
        getNextLinks = _libtraci.vehicle_getNextLinks
    if _newclass:
    ...
    if _newclass:
        getStopParameter = staticmethod(_libtraci.vehicle_getStopParameter)
    else:
        getStopParameter = _libtraci.vehicle_getStopParameter
    if _newclass:
    ...
    if _newclass:
        getTimeLoss = staticmethod(_libtraci.vehicle_getTimeLoss)
    else:
        getTimeLoss = _libtraci.vehicle_getTimeLoss
    if _newclass:
        getTaxiFleet = staticmethod(_libtraci.vehicle_getTaxiFleet)
    else:
        getTaxiFleet = _libtraci.vehicle_getTaxiFleet
    if _newclass:
        getLoadedIDList = staticmethod(_libtraci.vehicle_getLoadedIDList)
    else:
        getLoadedIDList = _libtraci.vehicle_getLoadedIDList
    if _newclass:
        getTeleportingIDList = staticmethod(_libtraci.vehicle_getTeleportingIDList)
    else:
        getTeleportingIDList = _libtraci.vehicle_getTeleportingIDList
    if _newclass:
    ...
    if _newclass:
        getBoardingDuration = staticmethod(_libtraci.vehicle_getBoardingDuration)
    else:
        getBoardingDuration = _libtraci.vehicle_getBoardingDuration
    if _newclass:
    ...
    if _newclass:
        insertStop = staticmethod(_libtraci.vehicle_insertStop)
    else:
        insertStop = _libtraci.vehicle_insertStop
    if _newclass:
        setStopParameter = staticmethod(_libtraci.vehicle_setStopParameter)
    else:
        setStopParameter = _libtraci.vehicle_setStopParameter
    if _newclass:
    ...
    if _newclass:
        setAcceleration = staticmethod(_libtraci.vehicle_setAcceleration)
    else:
        setAcceleration = _libtraci.vehicle_setAcceleration
    if _newclass:
    ...
    if _newclass:
        setLateralLanePosition = staticmethod(_libtraci.vehicle_setLateralLanePosition)
    else:
        setLateralLanePosition = _libtraci.vehicle_setLateralLanePosition
    if _newclass:
...
def vehicle_getDeparture(vehID):
    return _libtraci.vehicle_getDeparture(vehID)
vehicle_getDeparture = _libtraci.vehicle_getDeparture

def vehicle_getDepartDelay(vehID):
    return _libtraci.vehicle_getDepartDelay(vehID)
vehicle_getDepartDelay = _libtraci.vehicle_getDepartDelay
...
def vehicle_getLicenseNumber(vehID):
    return _libtraci.vehicle_getLicenseNumber(vehID)
vehicle_getLicenseNumber = _libtraci.vehicle_getLicenseNumber
...
def vehicle_getJunctionFoes(vehID, dist=0.):
    return _libtraci.vehicle_getJunctionFoes(vehID, dist)
vehicle_getJunctionFoes = _libtraci.vehicle_getJunctionFoes
...
def vehicle_getNextLinks(vehID):
    return _libtraci.vehicle_getNextLinks(vehID)
vehicle_getNextLinks = _libtraci.vehicle_getNextLinks
...
def vehicle_getStopParameter(vehID, nextStopIndex, param):
    return _libtraci.vehicle_getStopParameter(vehID, nextStopIndex, param)
vehicle_getStopParameter = _libtraci.vehicle_getStopParameter
...
vehicle_getTimeLoss = _libtraci.vehicle_getTimeLoss
...
def vehicle_getLoadedIDList():
    return _libtraci.vehicle_getLoadedIDList()
vehicle_getLoadedIDList = _libtraci.vehicle_getLoadedIDList

def vehicle_getTeleportingIDList():
    return _libtraci.vehicle_getTeleportingIDList()
vehicle_getTeleportingIDList = _libtraci.vehicle_getTeleportingIDList
...
def vehicle_getBoardingDuration(typeID):
    return _libtraci.vehicle_getBoardingDuration(typeID)
vehicle_getBoardingDuration = _libtraci.vehicle_getBoardingDuration
...
def vehicle_insertStop(*args, **kwargs):
    return _libtraci.vehicle_insertStop(*args, **kwargs)
vehicle_insertStop = _libtraci.vehicle_insertStop

def vehicle_setStopParameter(vehID, nextStopIndex, param, value):
    return _libtraci.vehicle_setStopParameter(vehID, nextStopIndex, param, value)
vehicle_setStopParameter = _libtraci.vehicle_setStopParameter
...
def vehicle_setAcceleration(vehID, accel, duration):
    return _libtraci.vehicle_setAcceleration(vehID, accel, duration)
vehicle_setAcceleration = _libtraci.vehicle_setAcceleration

def vehicle_setPreviousSpeed(*args, **kwargs):
    return _libtraci.vehicle_setPreviousSpeed(*args, **kwargs)
...
def vehicle_setLateralLanePosition(vehID, posLat):
    return _libtraci.vehicle_setLateralLanePosition(vehID, posLat)
vehicle_setLateralLanePosition = _libtraci.vehicle_setLateralLanePosition
...
vehicle.DOMAIN_ID = _libtraci.cvar.vehicle_DOMAIN_ID
...
class person(_object):
    ...
    if _newclass:
        getBoardingDuration = staticmethod(_libtraci.person_getBoardingDuration)
    else:
        getBoardingDuration = _libtraci.person_getBoardingDuration
    if _newclass:
    ...
    if _newclass:
        remove = staticmethod(_libtraci.person_remove)
    else:
        remove = _libtraci.person_remove
    if _newclass:
...
def person_getBoardingDuration(typeID):
    return _libtraci.person_getBoardingDuration(typeID)
person_getBoardingDuration = _libtraci.person_getBoardingDuration
...
def person_moveTo(*args, **kwargs):
    return _libtraci.person_moveTo(*args, **kwargs)
...
def person_remove(*args, **kwargs):
    return _libtraci.person_remove(*args, **kwargs)
person_remove = _libtraci.person_remove
...
person.DOMAIN_ID = _libtraci.cvar.person_DOMAIN_ID
...
calibrator.DOMAIN_ID = _libtraci.cvar.calibrator_DOMAIN_ID
...
busstop.DOMAIN_ID = _libtraci.cvar.busstop_DOMAIN_ID
...
parkingarea.DOMAIN_ID = _libtraci.cvar.parkingarea_DOMAIN_ID
...
chargingstation.DOMAIN_ID = _libtraci.cvar.chargingstation_DOMAIN_ID
...
overheadwire.DOMAIN_ID = _libtraci.cvar.overheadwire_DOMAIN_ID
...
rerouter.DOMAIN_ID = _libtraci.cvar.rerouter_DOMAIN_ID
...
meandata.DOMAIN_ID = _libtraci.cvar.meandata_DOMAIN_ID
...
variablespeedsign.DOMAIN_ID = _libtraci.cvar.variablespeedsign_DOMAIN_ID
...
routeprobe.DOMAIN_ID = _libtraci.cvar.routeprobe_DOMAIN_ID
