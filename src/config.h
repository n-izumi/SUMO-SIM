...
#define HAVE_ENABLED "Linux-5.15.146.1-microsoft-standard-WSL2 x86_64 GNU 7.5.0 Release FMI Proj GUI Intl SWIG FFmpeg GL2PS Eigen"
...
#define PROJ_API_FILE "proj_api.h"
