...
// lane ids (get: lane area detector)
TRACI_CONST int VAR_LANE_IDS = 0xf0;

// dist to detector end (get: lane area detector)
TRACI_CONST int VAR_DIST_TO_DETECTOR_END = 0xf1;
...
// number of vehicle license (get: vehicle)
TRACI_CONST int VAR_LICENSE_NUMBER = 0x79;
