...
/****************************************************************************/
/// @file    GUIDialog_StaticInformation.h
...
// ===========================================================================
/**
 * @class GUIDialog_StaticInformation
 * @brief The dialog to change the view (gui) settings.
 *
 * @todo Check whether saving/loading settings should be done via XML
 */
class GUIDialog_StaticInformation : public FXDialogBox, public GUIPersistentWindowPos {
    /// @brief FOX Declaration
    FXDECLARE(GUIDialog_StaticInformation)
...
public:
    ...
    public:
        /// @brief constructor
        NamePanel(FXMatrix* parent, GUIDialog_StaticInformation* target,
    ...
    public:
        /// @brief constructor
        SizePanel(FXMatrix* parent, GUIDialog_StaticInformation* target,
    ...
    private:
        ...
        GUIDialog_StaticInformation* myDialogStaticInformation = nullptr;
     ...
     */
    GUIDialog_StaticInformation(GUISUMOAbstractView* parent, GUIVisualizationSettings* settings);

    /// @brief FOX need this
    GUIDialog_StaticInformation() : myBackup("DUMMY") {}

    /// @brief Destructor
    ~GUIDialog_StaticInformation();
...
private:
    ...
    GUIDialog_StaticInformation(const GUIDialog_StaticInformation& s) = delete;

    /// @brief invalidated assignment operator
    GUIDialog_StaticInformation& operator=(const GUIDialog_StaticInformation& s) = delete;
};
